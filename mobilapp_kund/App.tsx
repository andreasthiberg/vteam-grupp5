          ...
          >
            ...
            {loggedIn ? (
              <>
                ...
                <Tab.Screen name="Scooter">
                  {() => <Scooter user={user} city={city} setCity={setCity} running={running} scooterId={scooterId} setScooterId={setScooterId} setRunning={setRunning} />}
                </Tab.Screen>
